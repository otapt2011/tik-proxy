// File: /api/video/[username]/[videoId].js
...
export default async function handler(req, res) {
  ...
  // Auth check (optional, keep if you want)
  ...
  try {
    ...
    // Extract the main JSON data from the video page
    ...
    // Navigate to the video data (structure might be slightly different from profile)
    ...
    // Build the same formatted object as before
    const formatted = {
      id: v.id,
